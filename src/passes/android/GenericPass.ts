 ...
 */
export default class GenericPass {
  keyFilePath: string;
  client: Walletobjects;
  credentials: {
    private_key: string,
    client_email: string;
  }
  ...
  auth() {
    ...
    // this.credentials = {
    //   "private_key": "AIzaSyCypGor4iHvsFfTG2UVHNs5-igwqNHCvRw",
    //   "client_email": "shubaivan232@gmail.com"
    // }
